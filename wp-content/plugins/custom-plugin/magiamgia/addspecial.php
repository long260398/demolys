...
<div class="wrap">
    ...
    <h1>
        Thêm cho khách hàng của thành viên đặc biệt
    </h1>
                    ...
                    <div class="postbox">
                        ...
                        <div class="inside">
                            ...
                            <table class="form-table ft_metabox leftform">
                                ...
                                <tr>
                                    <td>
                                        Tổng số lượng mã giảm giá muốn tạo <span class="red-validate">*</span>
                                    </td>
                                    <td>
                                        <div class="">
                                            <input type="number" class="inputnumber validate-input"
                                                   id="tong_so_luong_voucher" value="" placeholder="Nhập vào">
                                            <label id="tong_so_luong_voucher-error" class="error d-none"
                                                   for="tong_so_luong_voucher">Không được để trống ô</label>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr style="display: none">
                                    ...
                                    <td>
                                        <div class="">
                                            <input type="number" class="inputnumber validate-input"
                                                   id="tong_luot_sd_toi_da" value="1" placeholder="Nhập vào">
                                    ...
                                    <td>
                                        <div class="mucgiamtd">
                                            <div class="type-mgtd">
                                                ...
                                                <div class="typetd" style="display: none;">
                                                    <input type="radio" class="changetypeaplly" name="changetypeaplly"
                                ...
                                <tr class="product-show">
                                    ...
                                    <td>
                                        ...
                                        <label class="change-pro error d-none">Vui lòng chọn sản phẩm/thành viên được áp dụng</label>
                                    </td>
    ...
    $(document).ready(function () {
        ...
        $("body").on("click", "#publish", function () {
            ...
            if (check == 1) {
                ...
                var tong_so_luong_voucher = $('#tong_so_luong_voucher').val();

                grecaptcha.ready(function () {
                    grecaptcha.execute(site_key, {action: 'subscribe_save_mgg'}).then(function (token) {
                        $.ajax({
                            url: urlAjax,
                            type: 'POST',
                            cache: false,
                            ...
                            data: {
                                ...
                                dataChange,
                                special_member,
                                special: 1,// bien xac nhan ma giam gia cho khach hang cua thanh vien dac biet
                                tong_so_luong_voucher,
                                action: 'saveMGG1',
