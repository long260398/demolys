                            ...
                            <table class="form-table ft_metabox leftform">
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="validate-input" id="ten_chuong_trinh"
                                               name="ten_chuong_trinh" value="<?= $myrows->ten_chuong_trinh ?>"
                                               size="50" placeholder="Nhập vào">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="validate-input" id="ma_voucher" name="ma_voucher"
                                               value="<?= $myrows->ma_voucher ?>" size="50" placeholder="Nhập vào"
                                               readonly>
                                        ...
                                        <div class="loaigiamgia">
                                            <div class="type-gg">
                                                <select name="" id="loai_giam_gia">
                                                    <option <?= $myrows->loai_giam_gia == 1 ? 'selected' : '' ?>
                                                            value="1">Theo số tiền
                                                    </option>
                                                    <option <?= $myrows->loai_giam_gia == 2 ? 'selected' : '' ?>
                                                            value="2">Theo phần trăm
                                                    </option>
                                                </select>
                                            </div>
                                            <div class="price-gg">
                                        ...
                                        <div class="mucgiamtd">
                                            <div class="type-mgtd">
                                                <div class="typetd">
                                                    <input type="radio" class="checkboxmg" name="checkboxmg"
                                                           id="muc_giam_toi_da_1"
                                                           value="1" <?= $myrows->muc_giam_toi_da == 1 ? 'checked' : '' ?>>
                                                    <label
                                                            for="muc_giam_toi_da_1">Giới hạn</label>
                                                </div>
                                                <div class="typetd">
                                                    <input type="radio" class="checkboxmg" name="checkboxmg"
                                                           id="muc_giam_toi_da_2"
                                                           value="2" <?= $myrows->muc_giam_toi_da == 2 ? 'checked' : '' ?>>
                                                    <label
                                            ...
                                            <div class="price-mgtd">
                                                <input type="number" class="inputnumber" id="muc_giam_co_gioi_han"
                                                       value="<?= $myrows->muc_giam_co_gioi_han ?>"
                                                       placeholder="Nhập vào">
                                    ...
                                    <td>
                                        <div class="">
                                            <input type="number" class="inputnumber validate-input"
                                                   id="gia_tri_toi_thieu" value="<?= $myrows->gia_tri_toi_thieu ?>"
                                                   placeholder="Nhập vào">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="">
                                            <input type="number" class="inputnumber validate-input"
                                                   id="tong_luot_sd_toi_da" value="<?= $myrows->tong_luot_sd_toi_da ?>"
                                                   placeholder="Nhập vào">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="">
                                            <input type="number" class="inputnumber validate-input"
                                                   id="luot_sd_toi_da_nguoi_mua"
                                                   value="<?= $myrows->luot_sd_toi_da_nguoi_mua ?>"
                                                   placeholder="Nhập vào">
                                ...
                                <tr>
                                    <td colspan="2"><h2 class="title-mgg">Kiểu áp dụng cho sản phẩm hoặc thành viên</h2>
                                    </td>
                                </tr>

                                <tr>
                                    <td>
                                        Chọn kiểu áp dụng<span class="red-validate">*</span>
                                    </td>
                                    <td>
                                        <div class="mucgiamtd">
                                            <div class="type-mgtd">
                                                <div class="typetd">
                                                    <input type="radio" class="changetypeaplly" name="changetypeaplly"
                                                           id="kieu_voucher_1"
                                                           value="1" <?= $myrows->kieu_voucher == 1 ? 'checked' : '' ?>>
                                                    <label
                                                            for="kieu_voucher_1">Áp dụng cho sản phẩm</label>
                                                </div>
                                                <div class="typetd">
                                                    <input type="radio" class="changetypeaplly" name="changetypeaplly"
                                                           id="kieu_voucher_2"
                                                           value="2" <?= $myrows->kieu_voucher == 2 ? 'checked' : '' ?>>
                                                    <label for="kieu_voucher_2">Áp
                                                        dụng cho thành viên</label>
                                                </div>
                                            </div>
                                ...
                                <tr class="product-show <?= $myrows->kieu_voucher == 1 ? "" : "d-none" ?>">
                                    <td>Sản phẩm được áp dụng <span class="red-validate">*</span>
                                    </td>
                                    <td>
                                        <h2 class="button-change delivery_information" data-id="1">
                                            <span>Chọn sản phẩm</span></h2>
                                        <label class="change-pro error d-none">Vui lòng chọn sản phẩm/thành viên được áp
                                            dụng</label>
                                    </td>

                                </tr>

                                <tr class="user-show <?= $myrows->kieu_voucher == 1 ? "d-none" : "" ?>">
                                    <td>Thành viên được áp dụng <span class="red-validate">*</span>
                                    </td>
                                    <td>
                                        <h2 class="button-change delivery_information" data-id="2">
                                            <span>Chọn thành viên</span></h2>
                                        <label class="change-pro error d-none">Vui lòng chọn sản phẩm/thành viên được áp
                                            dụng</label>
                                    </td>
                                </tr>
...
<div class="popup_delivery_information">
    <div class="modal-address">
        <div class="popup__content">
            ...
            <div style="display: none" class="special-member-container">
...
<input type="hidden" id="code_id" value="<?= $_GET['id'] ?>">
...
<script>
    $(document).ready(function () {
        var currentPage = 1;
        var keyword = '';
        var dataChange = <?= ($myrows->voucher_product != NULL) ? $myrows->voucher_product : '[]' ?>;
        var statuskieuapdung =<?php echo $myrows->kieu_voucher ?>,
            statusmucgiamtoida =<?php echo $myrows->muc_giam_toi_da ?>; // statuskieuapdung,1: Áp dụng cho sản phẩm, 2: Áp dụng cho thành viên
        ...
        // });
        var voucher = <?= ($myrows->voucher_product != NULL) ? $myrows->voucher_product : '[]' ?>;
        ...
        function loadDefault() {
            ...
            var code_id = $("#code_id").val(); // Get page
